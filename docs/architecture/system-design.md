...
| 层级 | 技术选型 | 说明 |
|------|---------|------|
| 桌面框架 | **Tauri 2.x** | Rust 后端 + Web 前端，轻量、高性能、内嵌 WebView2 |
| 前端框架 | **React 18 + TypeScript** | 组件化 UI 开发 |
| 状态管理 | **Zustand** | 轻量级状态管理 |
| 画布引擎 | **React Flow (@xyflow/react)** | 脑图节点渲染与交互 |
| 代码编辑 | **Monaco Editor** | VS Code 同源代码编辑器 |
| 本地存储 | **SQLite** | 结构化元数据存储 |
| 文件处理 | **Rust 生态库** (walkdir, notify) | 文件系统操作、变更监听 |
